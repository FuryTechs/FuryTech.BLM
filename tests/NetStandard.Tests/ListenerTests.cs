...
namespace FuryTechs.BLM.NetStandard.Tests
{
  ...
  public class ListenerTests
  {
    ...
    public async Task Modified()
    {
      ...
      Assert.True(MockListener.EntitesWereNotTheSameOnCalling.HasValue &&
                  MockListener.EntitesWereNotTheSameOnCalling.Value);
    }
    ...
    public async Task MultipleModifiedListeners()
    {
      ...
      Assert.True(MockListener.EntitesWereNotTheSameOnCalling.HasValue &&
                  MockListener.EntitesWereNotTheSameOnCalling.Value);
      Assert.True(MockListener2.EntitesWereNotTheSameOnCalling.HasValue &&
                  MockListener2.EntitesWereNotTheSameOnCalling.Value);
      Assert.True(ObjectListener.EntitesWereNotTheSameOnCalling.HasValue &&
                  ObjectListener.EntitesWereNotTheSameOnCalling.Value);
    }
    ...
    public async Task LoadTest()
    {
      ...
      Assert.True(time < 10.000, "time < 3000");
